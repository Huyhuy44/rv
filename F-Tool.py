...
if __name__ == '__main__':
	commands = f"""{Fore.LC}HOME{Fore.LR} ~>{Fore.LY}Back to home
{Fore.LC}REF{Fore.LR} ~> {Fore.LY}Refresh the menu
{Fore.LC}CLEAR{Fore.LR} ~> {Fore.LY}Clear your face xd
{Fore.LC}EXIT{Fore.LR} ~> {Fore.LY}Exit the program
{Fore.LC}BBOS{Fore.LR} ~> {Fore.LY}L4/L7 DDOS Attack
{Fore.LC}STOP{Fore.LR} ~> {Fore.LY}Stop your Attack
{Fore.LC}DEV{Fore.LR} ~> {Fore.LY}Contact/Support dev"""
	dev = f"""{Fore.LC}Telegram{Fore.LR}: {Fore.LY}Updated
{Fore.LC}Momo{Fore.LR}: {Fore.LY}Updated"""
